...
def main():
    ...
    parser.add_argument('--latent-size', type=int, default=324)
    ...
    # -- StyleGAN2
        ...
        G = ConvVAE(num_channel=1, latent_size=args.latent_size, img_size=28)
    ...
    if args.gan_type=='VAE_MNIST' or args.gan_type=='VAE_DSPRITES' or args.gan_type=='VAE_Shapes' or args.gan_type== 'VAE_FALOR' or args.gan_type== 'VAE_ISAAC':

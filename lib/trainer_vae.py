...
class TrainerVAE(object):
    ...
    def train(self, generator, support_sets, reconstructor):
        ...
        for iteration in range(starting_iter, self.params.max_iter + 1):
            ...
            #time_stamp2 = time_stamp+1

            energy, latent1, latent2, loss_wave = support_sets(index,z,time_stamp,generator.decoder)
            #_, shift, loss_wave = support_sets(index, z, time_stamp, generator.decoder)
            #_, shift2, _ = support_sets(index,z,time_stamp2, generator.decoder)
            ...
            #classification_loss = nn.functional.kl_div(predicted_support_sets_indices+1e-5,label)
